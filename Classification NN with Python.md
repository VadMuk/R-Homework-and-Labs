...
# Tasks
1. Download dataset
2. Create an ANN model in tf.Keras
3. Set up training parameters
4. Train and evaluate the model
5. Modify the model and conduct a comparison. Explain the results.
...
The dataset is available for download.follow the link  https://www.kaggle.com/datasets/ypzhangsam/sonaralldata/data (sonar.all-data file). 

The downloaded file must be renamed to "sonar.csv" and placed in your project directory.
...
1) It is necessary to reduce the size of the input layer by half and compare with the results of the original architecture.
...
2) It is necessary to add an intermediate (hidden) Dense layer to the network architecture with 15 neurons and analyze the results.
